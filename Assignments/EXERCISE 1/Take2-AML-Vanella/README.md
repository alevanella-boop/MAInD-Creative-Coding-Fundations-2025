...
- allows the switch between two views (at least)
 ...
 Card view option, 3 columns for wide/medium screen view

 ![first screenshot, card view](DOCS/ex1-Vanella-card-view.png)

## Project description

This web application is a simple yet functional list designed for organizing tofu recipe ideas. Unfortunately, I didn't feel confident enough to make it into an actual recipe repository.
...
The option of removing items individually was the hardest to accomplish.
...
- Coding is a language: it is not just about "grammar" it needs a lot of practice too (and I still need tons of that)!
...
- Making a web page look good is actually a pretty difficult job